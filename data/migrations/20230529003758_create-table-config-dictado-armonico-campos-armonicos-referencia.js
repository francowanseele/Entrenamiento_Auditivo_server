...
exports.up = function(knex) {
    return knex.schema.createTable('ConfiguracionDictadoArmonico_CampoArmonicoReferencia', (table) => {
        table.increments();
...
exports.down = function(knex) {
    return knex.schema.dropTable('ConfiguracionDictadoArmonico_CampoArmonicoReferencia');
};
