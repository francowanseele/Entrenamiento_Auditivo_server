...
exports.up = function (knex) {
    return knex.schema.createTable('ConfiguracionDictadoArmonico_CampoArmonico', (table) => {
        table.increments();
...
exports.down = function (knex) {
    return knex.schema.dropTable('ConfiguracionDictadoArmonico_CampoArmonico');
};
